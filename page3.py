...
count_matrix = pd.read_table("/content/gdrive/My Drive/7in7 Final Project/count_matrix.txt", delimiter = ' ')
genes_metadata = pd.read_table("/content/gdrive/My Drive/7in7 Final Project/gene_metadata.txt", delimiter = ' ')
sample_metadata = pd.read_csv("/content/gdrive/My Drive/7in7 Final Project/sample_metadata.csv", delimiter = ",")
...
sample_metadata_filtered.head()

from statsmodels.graphics.mosaicplot import mosaic
import pandas as pd
data = sample_metadata_filtered[["paper_expression_subtype","paper_Tumor.stage"]]
data_df = pd.DataFrame(data)
mosaic(data_df, index = ["paper_expression_subtype","paper_Tumor.stage"], title='mosaic plot')
plt.show()